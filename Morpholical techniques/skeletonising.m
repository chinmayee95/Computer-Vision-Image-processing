...
%Implementation: Skeletonising
%%%%%%%%%%%%%%%%%%%%%%%%%%%
clear all;
clc;

image_raw=readraw('cup.raw');
...
figure(1);
imshow(uint8(image));
image_normalized=image./255; %normalizing betweem 0 and 1

N=3;   

img_copied = image_normalized;
skel_out=zeros(row,col);
...
while f
            ...
            if (img_copied_padded(i,j)==1)
                ...
                switch bond_value
                    ...
                    case 4
                        ...
                        elseif(isequal(Thin_Skeletonize_1,neighbouring_pixels_1D))
                            Mark_array(i-(N-1)/2,j-(N-1)/2)=1;
                        elseif(isequal(Thin_Skeletonize_2,neighbouring_pixels_1D))
                            Mark_array(i-(N-1)/2,j-(N-1)/2)=1;
                        elseif(isequal(Thin_Skeletonize_3,neighbouring_pixels_1D))
                            Mark_array(i-(N-1)/2,j-(N-1)/2)=1;
                        elseif(isequal(Thin_Skeletonize_4,neighbouring_pixels_1D))
                            Mark_array(i-(N-1)/2,j-(N-1)/2)=1;
                        end
                    ...
                    case 11
                        ...
                        if(isequal(Skeletonize_1,neighbouring_pixels_1D))
                            Mark_array(i-(N-1)/2,j-(N-1)/2)=1;
                        elseif(isequal(Skeletonize_2,neighbouring_pixels_1D))
                            Mark_array(i-(N-1)/2,j-(N-1)/2)=1;
                        elseif(isequal(Skeletonize_3,neighbouring_pixels_1D))
                            Mark_array(i-(N-1)/2,j-(N-1)/2)=1;
                        elseif(isequal(Skeletonize_4,neighbouring_pixels_1D))
                            Mark_array(i-(N-1)/2,j-(N-1)/2)=1;
                        end
    ...
    for i=1+(N-1)/2:row+(N-1)/2
        for j=1+(N-1)/2:col+(N-1)/2
            ...
            if(Mark_array_neighbour_pixels(2,2)==Mark_array_neighbour_pixels(2,1) && Mark_array_neighbour_pixels(1,1)==0 && Mark_array_neighbour_pixels(1,2)==0 && Mark_array_neighbour_pixels(1,3)==0 && Mark_array_neighbour_pixels(3,2)==0 && Mark_array_neighbour_pixels(2,3)==0 && Mark_array_neighbour_pixels(3,1)==0 && Mark_array_neighbour_pixels(3,3)==0)
                Uncond_mark_array(i-(N-1)/2,j-(N-1)/2)=1;
            end
            
            if(Mark_array_neighbour_pixels(2,2)==Mark_array_neighbour_pixels(1,2) && Mark_array_neighbour_pixels(1,1)==0 && Mark_array_neighbour_pixels(2,1)==0 && Mark_array_neighbour_pixels(1,3)==0 && Mark_array_neighbour_pixels(3,2)==0 && Mark_array_neighbour_pixels(2,3)==0 && Mark_array_neighbour_pixels(3,1)==0 && Mark_array_neighbour_pixels(3,3)==0)
                Uncond_mark_array(i-(N-1)/2,j-(N-1)/2)=1;
            end
            
            %L Corner
            
            if(Mark_array_neighbour_pixels(2,2)==Mark_array_neighbour_pixels(1,2) && Mark_array_neighbour_pixels(2,2)==Mark_array_neighbour_pixels(2,3) && Mark_array_neighbour_pixels(1,1)==0 && Mark_array_neighbour_pixels(1,3)==0 && Mark_array_neighbour_pixels(2,1)==0 && Mark_array_neighbour_pixels(3,1)==0 && Mark_array_neighbour_pixels(3,2)==0 && Mark_array_neighbour_pixels(3,3)==0)
                Uncond_mark_array(i-(N-1)/2,j-(N-1)/2)=1;
            end
            
            if(Mark_array_neighbour_pixels(2,2)==Mark_array_neighbour_pixels(1,2) && Mark_array_neighbour_pixels(2,2)==Mark_array_neighbour_pixels(2,1) && Mark_array_neighbour_pixels(1,1)==0 && Mark_array_neighbour_pixels(1,3)==0 && Mark_array_neighbour_pixels(2,3)==0 && Mark_array_neighbour_pixels(3,1)==0 && Mark_array_neighbour_pixels(3,2)==0 && Mark_array_neighbour_pixels(3,3)==0)
                Uncond_mark_array(i-(N-1)/2,j-(N-1)/2)=1;
            end
            
            if(Mark_array_neighbour_pixels(2,2)==Mark_array_neighbour_pixels(3,2) && Mark_array_neighbour_pixels(2,2)==Mark_array_neighbour_pixels(2,3) && Mark_array_neighbour_pixels(1,1)==0 && Mark_array_neighbour_pixels(1,3)==0 && Mark_array_neighbour_pixels(2,1)==0 && Mark_array_neighbour_pixels(3,1)==0 && Mark_array_neighbour_pixels(1,2)==0 && Mark_array_neighbour_pixels(3,3)==0)
                Uncond_mark_array(i-(N-1)/2,j-(N-1)/2)=1;
            end
            
            if(Mark_array_neighbour_pixels(2,2)==Mark_array_neighbour_pixels(3,2) && Mark_array_neighbour_pixels(2,2)==Mark_array_neighbour_pixels(2,1) && Mark_array_neighbour_pixels(1,1)==0 && Mark_array_neighbour_pixels(1,3)==0 && Mark_array_neighbour_pixels(2,3)==0 && Mark_array_neighbour_pixels(3,1)==0 && Mark_array_neighbour_pixels(1,2)==0 && Mark_array_neighbour_pixels(3,3)==0)
                Uncond_mark_array(i-(N-1)/2,j-(N-1)/2)=1;
            end
            ...
            if(Mark_array_neighbour_pixels(2,3)==Mark_array_neighbour_pixels(2,2) && Mark_array_neighbour_pixels(3,2)==Mark_array_neighbour_pixels(2,2) && Mark_array_neighbour_pixels(3,3)==Mark_array_neighbour_pixels(2,2))
                Uncond_mark_array(i-(N-1)/2,j-(N-1)/2)=1;
            end
            
            %Tee Branch
            
            if(Mark_array_neighbour_pixels(2,3)==Mark_array_neighbour_pixels(2,2) && Mark_array_neighbour_pixels(2,1)==Mark_array_neighbour_pixels(2,2) && Mark_array_neighbour_pixels(1,2)==Mark_array_neighbour_pixels(2,2))
                Uncond_mark_array(i-(N-1)/2,j-(N-1)/2)=1;
            end
            
            if(Mark_array_neighbour_pixels(3,2)==Mark_array_neighbour_pixels(2,2) && Mark_array_neighbour_pixels(2,1)==Mark_array_neighbour_pixels(2,2) && Mark_array_neighbour_pixels(1,2)==Mark_array_neighbour_pixels(2,2))
                Uncond_mark_array(i-(N-1)/2,j-(N-1)/2)=1;
            end
            
            if(Mark_array_neighbour_pixels(2,3)==Mark_array_neighbour_pixels(2,2) && Mark_array_neighbour_pixels(2,1)==Mark_array_neighbour_pixels(2,2) && Mark_array_neighbour_pixels(3,2)==Mark_array_neighbour_pixels(2,2))
                Uncond_mark_array(i-(N-1)/2,j-(N-1)/2)=1;
            end
            
            if(Mark_array_neighbour_pixels(3,2)==Mark_array_neighbour_pixels(2,2) && Mark_array_neighbour_pixels(1,2)==Mark_array_neighbour_pixels(2,2) && Mark_array_neighbour_pixels(2,3)==Mark_array_neighbour_pixels(2,2))
                Uncond_mark_array(i-(N-1)/2,j-(N-1)/2)=1;
            end
    ...
    for i=1:row
        for j=1:col
            skel_out(i,j)=img_copied(i,j) & (~Mark_array(i,j) | Uncond_mark_array(i,j));
        end
    end
    
    if(img_copied==skel_out)
        f=0;
    else
        f=1;
    end
