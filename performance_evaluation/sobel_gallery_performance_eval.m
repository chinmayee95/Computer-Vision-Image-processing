...
% 
% writeraw(threshold_95,'Gallery_threshold_95.raw');
% writeraw(threshold_80,'Gallery_threshold_80.raw');
writeraw(threshold_85,'Gallery_threshold_85.raw');

% imshow(unit8(threshold_85));
% writeraw(threshold_90,'Gallery_threshold_90.raw');
