...
writeraw(image_warped_raw,'warping_Hedwig.raw');
...
writeraw(image_reconstructed_raw,'warping_reconstructed_Hedwig.raw');
writeraw(image_interpolated_raw,'warping_interpolated_Hedwig.raw');
