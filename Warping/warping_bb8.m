...
writeraw(image_warped_raw,'warping_bb8.raw');
...
writeraw(image_reconstructed_raw,'warping_reconstructed_bb8.raw');
writeraw(image_interpolated_raw,'warping_interpolated_bb8.raw');
